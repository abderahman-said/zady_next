  ...
  return (
    ...
    <Col md={7} className={styles.imageGallery_left} >
      ...
      />
            ...
            <button className='add-cart'  onClick={() => handleAddToCart(productData.catId, productData.id , productData.name ,productData.mainImage)}>
            ...
            <>
                ...
                {productData.matched?.map((mat, index) => (
                   <SwiperSlide   key={mat.id}  className="card-cat-productData" >
                    ...
                    <LazyLoadImage loading="lazy"   src={`/api/images?id=${mat.image}`} alt={mat.name} width={190} height={170}  />
